...
class GenresController extends Controller
{
    ...
    public function delete($id){
        $genre = Genre::findOrFail($id);
        $genre->delete();
        return redirect()->route('show_genres')->with('alert-success','Genre hasbeen deleted!');
    }
    ...
    public function books($id){
        ...
        return view('genres.readBooks', compact('id', 'genre','books'));
    }
    ...
    public function authors($id){
        ...
        return view('genres.readAuthors', compact('id', 'genre','authors'));
    }
}
